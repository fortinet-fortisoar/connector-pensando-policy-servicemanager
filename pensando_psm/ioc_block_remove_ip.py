...
def ioc_block_remove_ip(config, params):
    """Will update two NetworkSecurityPolicy rules under an existing Policy.
    ...
    for ip in ioc_ip:
        try:
            ...
            logger.warn(f'{ip} not found in IOC list. Skipping.')
